...
#boss look - swap the path below if your boss art is named/located differently.
boss_image = pg.image.load('tds/assets/boss.jpeg').convert_alpha()
...
def display_data():
  ...
  if getattr(world, "boss_incoming", False):
      draw_text("BOSS WAVE", text_font, "red", c.WIDTH + 10, 100)
