...
# Images
map_image = pg.image.load('assets/map2.png').convert_alpha()
enemy_images = {
    "weak": pg.image.load('assets/slime.png').convert_alpha(),
...
# Sell Button Image
try:
    sell_image = pg.image.load('assets/Sell.png').convert_alpha()
...
with open('assets/map2.tmj') as file:
